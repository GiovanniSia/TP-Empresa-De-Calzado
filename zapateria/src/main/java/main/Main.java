...
public class Main {
	...
	public static void main(String[] args) {
		...
		CompraVirtualDTO cvd = new CompraVirtualDTO(detalle, 1, 500, 2, "Juan", "Lopez","4223004","juan@mgail.com","Mayorista","E","1002","201","Argentina","Buenos Aires","Bella Vista","1661");
		compras.add(cvd);
