...
public class Main {
	...
	public static void main(String[] args) {
		...
		CompraVirtualDTO cvd = new CompraVirtualDTO(detalle, 1, 35000, 2, "Juan", "Lopez","4223004","juan@mgail.com","Mayorista","E","1002","201","Argentina","Buenos Aires","Bella Vista","1661");
		compras.add(cvd);
		...
		CompraVirtualDTO cvd2 = new CompraVirtualDTO(detalle, 1, 14020, 1, "Sebas",
				"Cubilla", "1231312319987654", "sebastianx3600@gmail.com", "Minorista", 
