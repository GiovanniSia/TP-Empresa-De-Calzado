...
public class VentanaVerPedidosAProveedores {
	...
	private String[] nombreColumnasTablaPedidos = {"Id","Proveedor","Producto","Cantidad","Uni. Medida","Precio de pedido","Estado","Fecha - hora de alta","Fecha - hora de envio","Fecha - hora de cierre","Total pagado"};
