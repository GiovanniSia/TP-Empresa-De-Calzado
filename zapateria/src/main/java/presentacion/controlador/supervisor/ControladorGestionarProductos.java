...
public class ControladorGestionarProductos {
	...
	public void agregarATabla(StockDTO s, MaestroProductoDTO m) {
		...
		Object[] fila = { id, nombre, tipo, propio, costoProduccion, precioMayo, precioMino, puntoRepMin, idProv, talle,
				medida, estado, cantARep, diasARep, stockDisp, codLote };
...
//		        	}
	...
	public static void main(String[] args) {
		...
		ControladorGenerarPedidoAProveedorManualmente controladorGenerarPedidoAProveedorManualmente = new ControladorGenerarPedidoAProveedorManualmente(
				prov, stock, pedi, prodProv);
